...
func TestSendConnectUseCase_Handle(t *testing.T) {
	...
	tests := []struct {
		...
		{"ok", &mockRepoConnect{circuit: cir}, &mockTxConnect{}, usecase.SendConnectInput{CircuitID: cid, Target: "x"}, false},
		{"circuit not found", &mockRepoConnect{circuit: nil, err: errors.New("nf")}, &mockTxConnect{}, usecase.SendConnectInput{CircuitID: cid}, true},
		{"bad id", &mockRepoConnect{}, &mockTxConnect{}, usecase.SendConnectInput{CircuitID: "bad"}, true},
		{"tx error", &mockRepoConnect{circuit: cir}, &mockTxConnect{err: errors.New("fail")}, usecase.SendConnectInput{CircuitID: cid}, true},
	}
