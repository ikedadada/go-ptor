...
// DataUseCase handles data transfer operations
...
// NewDataUseCase creates a new data use case
func NewDataUseCase(repo repository.ConnStateRepository, crypto service.CryptoService, sender service.CellSenderService) DataUseCase {
...
func (uc *dataUseCaseImpl) Data(st *entity.ConnState, cid vo.CircuitID, cell *entity.Cell, ensureServeDown func(*entity.ConnState)) error {
